# This is the correct impementation as it also relates x with y
# ------------
# User Instructions
#
...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    Xi.value[1][1] = world_size/2.0

    # process the data

    for k in range(len(data)):
        # n is the index of robot pose
        n = k*2
        ...
        for b in range(2):
            ...
            Xi.value[n+b][n+b+2] += -motion[b]/motion_noise
            Xi.value[n+b+2][n+b] += -motion[b]/motion_noise
